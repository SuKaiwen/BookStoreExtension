...
-- --------------------------------------------------
-- Date Created: 03/29/2020 16:39:47
-- Generated from EDMX file: C:\Users\Kevin Su\Desktop\BookStore\BookStore.Entities\BookStore.Business.Entities\BookStoreEntityModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_PurchaseHistoryMedia]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PurchaseHistories] DROP CONSTRAINT [FK_PurchaseHistoryMedia];
GO
IF OBJECT_ID(N'[dbo].[FK_PurchaseHistoryUser]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PurchaseHistories] DROP CONSTRAINT [FK_PurchaseHistoryUser];
GO
...
GO
IF OBJECT_ID(N'[dbo].[PurchaseHistories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PurchaseHistories];
GO
...
-- Creating foreign key on [Media_Id] in table 'PurchaseHistories'
ALTER TABLE [dbo].[PurchaseHistories]
ADD CONSTRAINT [FK_PurchaseHistoryMedia]
    FOREIGN KEY ([Media_Id])
    REFERENCES [dbo].[Media]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_PurchaseHistoryMedia'
CREATE INDEX [IX_FK_PurchaseHistoryMedia]
ON [dbo].[PurchaseHistories]
    ([Media_Id]);
GO

-- Creating foreign key on [Users_Id] in table 'PurchaseHistories'
ALTER TABLE [dbo].[PurchaseHistories]
ADD CONSTRAINT [FK_PurchaseHistoryUser]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_PurchaseHistoryUser'
CREATE INDEX [IX_FK_PurchaseHistoryUser]
ON [dbo].[PurchaseHistories]
    ([Users_Id]);
GO
