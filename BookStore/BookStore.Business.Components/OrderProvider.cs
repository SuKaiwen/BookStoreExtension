        ...
        public void SubmitOrder(Entities.Order pOrder)
        {
            ...
            using (BookStoreEntityModelContainer lContainer = new BookStoreEntityModelContainer())
            {
                ...
                foreach(OrderItem orderitem in pOrder.OrderItems)
                {
                    ...
                    purchases.Media = orderitem.Media;
                    purchases.Users = pOrder.Customer;
                    purchases.Rating = null;
                    purchases.RatingDate = DateTime.Now;
                    lContainer.PurchaseHistories.Add(purchases);
                }
